...
_Note: I tried two different coloring schemes in the "Medicaid vs. Medicare coverage, by county (sorted by percent (%) public coverage of total population)" visualization. The **bottom** coloring scheme is based off of U.S. Census Bureau-designated regions. 
...
* Region 4 is the West (colored GREEN, which contains the Mountain (Arizona, Colorado, Idaho, Montana, Nevada, New Mexico, Utah, and Wyoming) and the Pacific regions (Alaska, California, Hawaii, Oregon, and Washington)._
